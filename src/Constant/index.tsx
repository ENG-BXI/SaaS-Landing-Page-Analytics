 ...
 * Assets
 */
import {ChartArea, Building2, Component, Code, BetweenHorizonalEnd, BrainCircuit, Blocks, Terminal, Package, SquareMousePointer, ChartPie, Files, UserRoundPen, GitFork, LaptopMinimal, ArrowBigDownDash, CreditCard, Twitter, Github, Linkedin, Instagram, Youtube} from 'lucide-react';

import {feature1, feature2, blog2, blog3, avatar1, avatar3} from '@/assets';
...
export const heroData = {
  ...
  decoTitle: 'analytics',
  sectionText: 'Next-gen user analytics: Gain valuable insights into user behavior and drive data-informed decision-making with our revolutionary platform.'
};
...
export const overviewData = {
  ...
  sectionText: 'Powerful analytics made easy. Make data-driven decisions with our all-in-one tool.',
